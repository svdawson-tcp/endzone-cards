...
const DesktopSidebar = () => {
  ...
  return (
    <aside className="hidden md:block fixed left-0 top-20 md:top-28 h-[calc(100vh-5rem)] md:h-[calc(100vh-7rem)] w-60 bg-[hsl(var(--nav-bg))] border-r border-[hsl(var(--border-strong))] z-30">
