...
const TopBar = ({ onMenuToggle, showMobileMenu = false }: TopBarProps) => {
  ...
  return (
    <div 
      className="z-50 shadow-sm animate-header-glow h-20 md:h-28 w-full bg-[url('/images/endzone-3d-header.png')] md:bg-[url('/images/endzone-3d-header-desktop.png')] bg-cover md:bg-[length:auto_100%] md:bg-left bg-center bg-no-repeat"
    >
