  ...
  return (
    <div className="min-h-screen bg-background p-4 pb-24 md:pb-8">
      <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="space-y-4">
            <Card className="p-6 bg-card border-border shadow-md border-l-4 border-l-primary">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold card-foreground mb-2">Part-Time Side Hustle</h3>
                  <p className="text-sm card-foreground/80 mb-2">
                    1-2 shows per month, evenings/weekends only. Goal: Supplement income while 
                    learning the business and building inventory.
                  </p>
                  <div className="text-sm card-foreground/70 font-semibold">
            ...
            <Card className="p-6 bg-card border-border shadow-md border-l-4 border-l-primary">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold card-foreground mb-2">Serious Side Business</h3>
                  <p className="text-sm card-foreground/80 mb-2">
            ...
            <Card className="p-6 bg-card border-border shadow-md border-l-4 border-l-primary">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold card-foreground mb-2">Full-Time Business</h3>
                  <p className="text-sm card-foreground/80 mb-2">
        ...
        {/* Next Steps */}
        <Card className="p-6 bg-card border-border shadow-md">
          <h3 className="text-lg font-bold card-foreground mb-3">Ready to Set Your Goals?</h3>
          <p className="text-sm card-foreground/80 mb-4">
