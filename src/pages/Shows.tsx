          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sortedShows.map((show) => (
              ...
              >
                ...
                {/* Show Name */}
                <h3 className="text-h3 mb-4 pr-20">{show.name}</h3>
                ...
                <div className="space-y-3 mb-4">
                  ...
                  {show.location && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-[hsl(var(--text-body))]">{show.location}</span>
                    </div>
                  )}
                ...
                <div className="flex flex-col gap-2 pt-4 border-t border-border">
                  ...
                  {/* View, Edit and Delete Buttons - always visible */}
                  <div className="flex gap-2">
                    <Button
                      variant="outline"
                      size="sm"
                      className="flex-1 text-[hsl(var(--text-body))] border-[hsl(var(--border-default))]"
                    ...
                    <Button
                      ...
                      className="text-[hsl(var(--color-danger))] border-[hsl(var(--border-default))] hover:bg-[hsl(var(--color-danger))] hover:text-white"
                    >
