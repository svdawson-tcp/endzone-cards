export const kpiTooltips = {
  ...
  taxSetAside: "4% of gross sales in this period. Move it to the Tax account. Platforms report your gross sales to the IRS, so reserve on gross, not on what you received.",
  ...
  grossSales: "What buyers paid, before platform fees, for the sales where you entered it. Sales without that figure count at the amount you received.",
  platformFees: "What eBay, Whatnot and the rest kept. Only counts sales where you entered what the buyer paid.",
  byChannel: "Where your sales came from. Fees show only for channels where you've entered what the buyer paid.",
